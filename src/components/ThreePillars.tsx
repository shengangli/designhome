            ...
            >
              ...
              <div className="relative bg-white/40 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm hover:shadow-md hover:bg-white/50 hover:border-white/20 transition-all duration-700 ease-out h-full">
                ...
                <div className="relative mb-6">
                  <div className="relative w-full h-40 mx-auto mb-4 overflow-hidden rounded-xl">
                    <Image
                      src={pillar.image}
                      alt={pillar.alt}
                      fill
                    ...
                    {/* Index Number */}
                    <div className="absolute top-3 left-3 w-10 h-10 bg-white/8 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 group-hover:bg-white/12 group-hover:border-white/30 transition-all duration-700 ease-out">
                    ...
                    <div className="absolute bottom-3 left-3 right-3">
                      <div className="inline-block px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-full">
                ...
                <div className="relative z-10 text-center">
                  <h3 className="text-lg font-medium mb-3 text-gray-800 leading-tight group-hover:text-gray-900 transition-colors duration-700 ease-out">
                    {pillar.title}
                  </h3>
                  
                  <p className="text-sm text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-700 ease-out">
                    {pillar.description}
                  </p>
